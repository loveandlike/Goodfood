...
import com.example.administrator.eatgood.adapter.FragmentOneAdapter_1;
...
public class Fragment_three extends Fragment {
    FragmentOneAdapter_1 fragmentOneAdapter_1;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentOneAdapter_1 = new FragmentOneAdapter_1(getContext(), dbUtil);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(fragmentOneAdapter_1);
        fragmentOneAdapter_1.notifyDataSetChanged();
...
//        跳转
        fragmentOneAdapter_1.setOnItemClickListener(new FragmentOneAdapter_1.ItemClick() {
            @Override
            public void setOnItemClick(int position) {
                pos=dbUtil.getCaiList().get(position).getPosition();
                Intent intent = new Intent(getContext(), ActivityShow.class);
                intent.putExtra("menu", dbUtil.getCaiList().get(position).getMenu());
